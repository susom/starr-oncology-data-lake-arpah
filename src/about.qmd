...
a) an encounter of type ‘tumor board’ 
**OR**
b) a case record in Stanford’s Neuralframe dataset
...
Our EHR data was initially standardized using OMOP CDM version 5.3.1 and subsequently upgraded to OMOP CDM version 5.4 to leverage the latest data model enhancements. 
