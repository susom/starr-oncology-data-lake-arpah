---
title: "Demographic & Clinical Metrics"
execute:
  echo: false
---
...
Data source: Oncology-IRIB76049-DateRelease
...
This report presents a characterization of patients within the ARPA-H population (~200k) derived from the OMOP Common Data Model. The demographic categories examined include Age, Sex, Race, and Ethnicity.
...
The following metrics were identified for individuals with thoracic cancer within the ARPA-H cohort (200k).
```{r, message=FALSE, warning=FALSE, results='hide'}
credentials_path <- "/home/rstudio/.config/gcloud/application_default_credentials.json"
