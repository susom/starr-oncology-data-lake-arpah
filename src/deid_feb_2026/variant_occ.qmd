...
comutation_data <- fetch_data_from_sql_file(sql_comutation, yaml_file_path, release = "feb_2026")
```
...
### Source Code
The source code for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/variant_occ.qmd), and the SQL queries that support these metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/sql_std/omop/variant_occ/feb26).
