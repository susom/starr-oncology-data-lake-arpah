...
lung_questions <- tribble(
  ...
  "Staging (AJCC/UICC)", c("PRIMARY TUMOR (PT)", "PN CATEGORY", "PM CATEGORY (REQUIRED ONLY IF CONFIRMED PATHOLOGICALLY)", "TNM DESCRIPTORS"),
  ...
  "Additional Findings / Metadata", c("ADDITIONAL FINDINGS")
)
