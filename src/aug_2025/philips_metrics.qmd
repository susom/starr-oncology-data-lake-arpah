...
:::
### Source Queries:
The source codes for this page can be found [here](/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/philips_metrics.qmd), and the sql queries that support the metrics can be found [here](/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/sql/philips). 
