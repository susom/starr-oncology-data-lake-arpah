...
### Source Queries:
The queries related to the following analysis can be accessed [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/aug_2025/sql/image_occ). 
The queries related to the following tables and graphs can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/aug_2025/image_occ.qmd).
The queries regarding thoracic cancer can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/aug_2025/sql/image_occ/image_occ_thoracic)
