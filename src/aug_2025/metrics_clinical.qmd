...
den <- "/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/sql/arpah_cohort/arpah_denominators_update.sql"
...
### Source Queries:
The queries related to the following analysis can be accessed [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/aug_2025/sql/arpah_cohort). 
The queries related to the following tables and graphs can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/blob/main/src/aug_2025/metrics_clinical.qmd).
...
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_ids <- "/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/sql/arpah_cohort/arpah_overlap_metrics_updated.sql"
