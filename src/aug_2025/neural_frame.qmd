...
### Source Queries:
The queries related to the following analysis can be accessed [here](/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/sql/neuralframe). 
The queries related to the following tables and graphs can be found [here](/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/neural_frame.qmd).
The queries regarding thoracic cancer can be found [here](/workspaces/starr-oncology-data-lake-arpah/src/aug_2025/sql/scr/thoracic)
