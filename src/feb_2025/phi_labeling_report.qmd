...
create_histogram_from_counts <- function(data, x_axis_title, plot_title) {
...
df_ethnicity_combined <- df_note_characteristics %>%
  ...
  full_join(df_ethnicity_groups_omop %>%
