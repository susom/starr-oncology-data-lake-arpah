...
res_all <- res_all %>%
  mutate(
    metric = case_when(
      ...
      sql_file_name == "powerpath_beaker_path_person_metrics.sql" ~ "Number of patients with pathology beaker",
      sql_file_name == "powerpath_path_person_metrics.sql" ~ "Number of patients with pathology path",
      TRUE ~ NA_character_
    )
  )
print(res_all)
