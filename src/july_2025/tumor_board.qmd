...
### Summary:
As of july 2025, Tumor Board encounters are defined -- TBD
...
As of July 2025, From `r format(res_den_thr$counts[2], big.mark = ",")` patients with thoracic cancer, `r format(tb_den$patient_count[1] , big.mark = ",")` also had a Tumor Board encounter. 
