...
|:----------------------------------------------------|:---------------|:-----------|:------|:--------------------------|
| variant_occurrence_id (PK)                          | INT64          | Yes        |       | Not Stable between Data Refreshes                    |
| person_id (FK)                                      | INT64          | Yes        | Yes   | Sub with Stable between Data Refreshes                       |
| visit_occurrence_id (FK)                            | INT64          | No         | Yes   | Sub with Stable between Data Refreshes                    |
| procedure_occurrence_id (FK)                        | INT64          | No         |       | Not Stable between Data Refreshes                    |
| provider_id (FK)                                    | INT64          | No         | Yes   | Sub with Stable between Data Refreshes                    |
| order_datetime                                      | DATETIME       | No         |       | Jitt                      |
...
| interpretation                                      | STRING         | No         |       | Whitelist                 |
| accession_number                                    | STRING         | No         |       | Hash                      |
