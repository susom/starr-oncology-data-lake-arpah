...
|:----------------------------------------------------|:--------|:-----------|:------|:--------------------------|
| location_id                                         | INTEGER | Yes        | Yes    | Sub Not Stable between Data Refreshes                    |
...
| latitude                                            | FLOAT   | No         | Yes   | Del                       |
| longitude                                           | FLOAT   | No         | Yes   | Del                       |
                    |
| _census_block_group (available only at Stanford)    | STRING  | No         | Yes   | Del                       |
