...
|:----------------------------------------------------|:--------|:-----------|:------|:--------------------------|
| payer_plan_period_id                                | INTEGER | Yes        |  Yes     | Sub Not Stable between Data Refreshes                    |
| person_id                                           | INTEGER | Yes        | Yes   | Sub with Stable between Data Refreshes                       |
| payer_plan_period_start_date                        | DATE    | Yes        | Yes   | Jitter                      |
| payer_plan_period_end_date                          | DATE    | Yes        | Yes   | Jitter                      |
| payer_concept_id                                    | INTEGER | Yes        |       |                        |
| payer_source_value                                  | STRING  | No         |    |                        |
...
| family_source_value                                 | STRING  | No         |    |                        |
| stop_reason_concept_id                              | INTEGER | Yes        |       |                        |
| stop_reason_source_value                            | STRING  | No         |    |                        |
