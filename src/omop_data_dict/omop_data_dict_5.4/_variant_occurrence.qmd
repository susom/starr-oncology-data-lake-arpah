...
|:----------------------------------------------------|:---------------|:-----------|:------|:--------------------------|
| variant_occurrence_id (PK)                          | INT64          | Yes        | Yes   | Sub Not Stable between Data Refreshes                       |
...
| procedure_occurrence_id (FK)                        | INT64          | No         | Yes   | Sub                       |
...
| interpretation                                      | STRING         | No         | Yes   | Del                       |
