...
|:----------------------------------------------------|:---------|:------|:-----------|
| drug_exposure_id                                    | INTEGER  |       | Yes        |
| person_id                                           | INTEGER  |       | Yes        |
| drug_concept_id                                     | INTEGER  |       | Yes        |
| drug_exposure_start_date                            | DATE     | Yes   | No         |
| drug_exposure_start_datetime                        | DATETIME | Yes   | Yes        |
| drug_exposure_end_date                              | DATE     | Yes   | No         |
| drug_exposure_end_datetime                          | DATETIME | Yes   | Yes        |
| verbatim_end_date                                   | DATE     | Yes   | No         |
