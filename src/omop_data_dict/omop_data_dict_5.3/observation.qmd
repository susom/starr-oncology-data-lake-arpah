...
|:----------------------------------------------------|:---------|:-----------|:------|:--------------------------|
| observation_id                                      | INTEGER  | Yes        |     Yes  | Sub Not Stable between Data Refreshes                    |
| person_id                                           | INTEGER  | Yes        |   Yes    | Sub with Stable between Data Refreshes                       |
| observation_concept_id                              | INTEGER  | Yes        |       |                        |
| observation_date                                    | DATE     | No         | Yes   | Jitter                      |
| observation_datetime                                | DATETIME | Yes        | Yes   | Jitter                      |
...
| observation_source_value                            | STRING   | No         |  Yes  |     TiDE                   |
| observation_source_concept_id                       | INTEGER  | Yes        |       |                        |
| unit_source_value                                   | STRING   | No         |    |                        |
| qualifier_source_value                              | STRING   | No         |       |                    |
