...
| payer_plan_period_start_date                        | DATE    | Yes   | Yes        |
| payer_plan_period_end_date                          | DATE    | Yes   | Yes        |
| payer_concept_id                                    | INTEGER |       | Yes        |
| payer_source_value                                  | STRING  | Yes   | No         |
| payer_source_concept_id                             | INTEGER |       | Yes        |
| plan_concept_id                                     | INTEGER |       | Yes        |
| plan_source_value                                   | STRING  | Yes   | No         |
...
| family_source_value                                 | STRING  | Yes   | No         |
| stop_reason_concept_id                              | INTEGER |       | Yes        |
| stop_reason_source_value                            | STRING  | Yes   | No         |
| stop_reason_source_concept_id                       | INTEGER |       | Yes        |
| trace_id (Stanford construct for traceability)      | STRING  | Yes   | No         |
| load_table_id (Stanford construct for traceability) | STRING  | Yes   | No         |
