...
February 2026 release includes additional clinical tables such as `whole_slide_imaging` and `variant_occurrence` that are not part of the standard OMOP CDM 5.4.2 but have been added to support the oncology use case. These tables are described in the data dictionary section for the February 2026 release.
