...
The February 2026 release includes additional clinical tables, such as `_whole_slide_imaging` and `_variant_occurrence`, that are not part of the standard OMOP CDM 5.4.2 but were added to support the oncology use case. The August 2026 release additionally includes `_external_death_table`. These tables are described in the corresponding release sections of the data dictionary.

::: {.panel-tabset}

#### OMOP CDM 5.4.2 

The following OMOP-CDM 5.4.2 tables are available in the February 2026 release:

| Category            | Table Name                                                                                   |
|---------------------|----------------------------------------------------------------------------------------------|
| Clinical Data       | [condition_occurrence](omop_data_dict/omop_data_dict_5.4/condition_occurrence.qmd), [drug_exposure](omop_data_dict/omop_data_dict_5.4/drug_exposure.qmd), [device_exposure](omop_data_dict/omop_data_dict_5.4/device_exposure.qmd), [measurement](omop_data_dict/omop_data_dict_5.4/measurement.qmd), [observation](omop_data_dict/omop_data_dict_5.4/observation.qmd), [procedure_occurrence](omop_data_dict/omop_data_dict_5.4/procedure_occurrence.qmd), [image_occurrence](omop_data_dict/omop_data_dict_5.4/image_occurrence.qmd), [visit_occurrence](omop_data_dict/omop_data_dict_5.4/visit_occurrence.qmd), [visit_detail](omop_data_dict/omop_data_dict_5.4/visit_detail.qmd), [note](omop_data_dict/omop_data_dict_5.4/note.qmd), [death](omop_data_dict/omop_data_dict_5.4/death.qmd),[_external_death_table](omop_data_dict/omop_data_dict_5.4/external_death_table.qmd), [specimen](omop_data_dict/omop_data_dict_5.4/specimen.qmd), [whole_slide_imaging](omop_data_dict/omop_data_dict_5.4/whole_slide_imaging.qmd), [variant_occurrence](omop_data_dict/omop_data_dict_5.4/variant_occurrence.qmd) |
| Standardized Derived Elements | [observation_period](omop_data_dict/omop_data_dict_5.4/observation_period.qmd), [person](omop_data_dict/omop_data_dict_5.4/person.qmd)  |
...
::: {.callout-note}
**Please Note:** The current ETL pipeline does not populate the following tables, which are empty for each release: `cost`, `dose_era`, `cohort_definition`, `specimen`, `source_to_concept_map`, `note_nlp`, `episode_event`, `condition_era`, and `cohort`. These tables remain part of the OMOP schema for standardization and future compatibility, but no source data is currently mapped or loaded into them for this release.
:::
...
* [Case Events](neuralframe_data_dict/case_events.qmd)
