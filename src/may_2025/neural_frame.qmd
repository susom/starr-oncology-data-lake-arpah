...
## Thoracic Cancer Metric Summary {.tabset}
...
thr_his <- thr_his %>%
  mutate(histology_group = case_when(
    ...
    between(as.numeric(histologicTypeIcdO3), 8010, 8015) ~ 'Large Cell Carcinoma',
...
thr_his_res<- thr_his_summary %>% select (histology_group, histologicTypeIcdO3Description, histology_codes, patient_count, percentage)


# Display using DT for interactive table
DT::datatable(thr_his_res,
