...
```{r,message=FALSE, warning=FALSE , results='hide'}
gene_sql<-"/workspaces/starr-oncology-data-lake-arpah/src/sql/philips/philips_chrom_genes.sql"
...
gene %>%
  ...
  labs(x = "HGNC Gene", y = "Count", title = "Top Genes by Aberration Class") +
  theme_minimal()
