...
As of May 2025, From `r format(res_den_thr$counts[2], big.mark = ",")` patients with thoracic cancer, `r format(tb_den$patient_count[1] , big.mark = ",")` also had Tumor Board encounter. 
...
```
The distribution of case status for Tumor Board encounter patients are listed below:
