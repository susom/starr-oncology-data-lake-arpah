...
The OMOP image_occurrence table captures records of medical imaging events at the series level, representing events where one or more related images are acquired as part of a clinical procedure, and it also provides a path to deidentified DICOM images.
...
### All Cancer Types 
## Modality Types
Top modality  types for series above 5000 are listed as follow.
...
## Anatomic Sites
Top anatomic sites for series above 5000 are listed as follow.
...
plot <- plot_ly() %>%
  ...
  layout(
    ...
    yaxis2 = list(
      ...
      overlaying = "y",
      showline = FALSE,          
    showgrid = FALSE            # Hide grid if desire
    ),
