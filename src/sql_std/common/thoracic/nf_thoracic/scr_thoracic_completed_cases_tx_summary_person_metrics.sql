...
from
scr_tx
inner join scr_thoracic_dx on scr_thoracic_dx.person_id = scr_tx.person_id
...
from
scr_thoracic_tx
inner join person p on p.person_id = scr_thoracic_tx.person_id
),
...
radiation_flag,
surgery_flag
from scr_omop_thoracic_tx_summary s
