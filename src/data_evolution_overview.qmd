...
### May 2026 - WSI and Episode Table

The May 2026 release further expands the data lake with additional whole slide imaging data and the introduction of an episode table:

- **Whole Slide Imaging Expansion**: Continued integration of manually scanned, deidentified histopathology slides with expanded coverage and improved metadata quality
...
release_summary <- tibble::tribble(
  ...
  "Added episode table to OMOP schema; Expanded WSI coverage; Added Heme-STAMP test results to variant_occurrence table",
...
identifier_keys <- tibble::tribble(
  ~Dataset, ~February_2025, ~May_2025, ~August_2025, ~November_2025, ~February_2026, ~May_2026,
