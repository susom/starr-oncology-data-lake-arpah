...
digraph vista_data_lake {
  ...
  {rank = same; OMOP; NF; IMG; PHILIPS; SPECIAL}
  OMOP [label = 'OMOP CDM 5.4.2\nClinical Data', fillcolor = '#8dd3c7', fontsize = 12, width = 2.5, height = 0.8]
  NF [label = 'NeuralFrame\nRegistry', fillcolor = '#ffffb3', fontsize = 12, width = 2.5, height = 0.8]
  IMG [label = 'Imaging\n1.6M+ Patients', fillcolor = '#bebada', fontsize = 12, width = 2.5, height = 0.8]
  ...
  OMOP_SUB [label = 'Demographics | Encounters\nDiagnoses | Procedures\nMedications | Lab Results\nClinical Notes | Tumor Board', fillcolor = '#E0F2F1', fontsize = 10, width = 2.5, height = 1.5, shape = box]
  
  NF_SUB [label = 'Cancer Diagnoses\nTreatments\nOutcomes\nMiscellaneous Details', fillcolor = '#FFFEF0', fontsize = 10, width = 2.5, height = 1.5, shape = box]
  
  IMG_SUB [label = 'CT | PET | MRI | X-Ray\nDICOM Metadata\nAnatomic Regions\nStudy & Series Info', fillcolor = '#F3E5F5', fontsize = 10, width = 2.5, height = 1.5, shape = box]
  
  PHILIPS_SUB [label = 'STAMP\nHeme-STAMP\nFoundationOne\nSTAMP Add-On Metadata', fillcolor = '#FFE4E1', fontsize = 10, width = 2.5, height = 1.5, shape = box]
  
  SPECIAL_SUB [label = 'HIPPO Benchmark (1,394 notes)\nCAP Pathology Forms\nEpic Media Server PDFs\nTide 2.0 Agentic AI', fillcolor = '#FFF8DC', fontsize = 10, width = 2.5, height = 1.5, shape = box]
  
  # Connections from Data Lake to main components
  DL -> OMOP [penwidth = 2, color = '#457B9D']
  DL -> NF [penwidth = 2, color = '#457B9D']
  DL -> IMG [penwidth = 2, color = '#457B9D']
  ...
  IMG -> IMG_SUB [arrowhead = none, color = '#bebada', penwidth = 3]
