...
The Event Table content has been moved to a dedicated page so it is easier to find and navigate.

- Open the full Event Table page: [Neural Frame Event Table](neural_frame_event_table.qmd)
