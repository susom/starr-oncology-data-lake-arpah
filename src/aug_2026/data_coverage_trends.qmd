...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      ...
      categoryorder = "array",
      categoryarray = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026", "may_2026")
    ),
    yaxis = list(
...
- Feb 2026 and May 2026 Philips ISPM/Genomic Data includes patients from OMOP _variant_occurrence table combined with Philips ISPM data.
...
if (nrow(ctsa_res) == 0) {
  ...
  ctsa_res <- ctsa_res %>% 
    mutate(month = factor(month, levels = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026"))) %>%
  ...
  ctsa_res <- ctsa_res %>%
    mutate(release_label = factor(
      ...
      levels = c("February 2025", "May 2025", "August 2025", "November 2025", "February 2026", "May 2026")
    ))
...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      categoryorder = "array",
      categoryarray = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026")
    ),
    yaxis = list(
      title = "Count",
      tickformat = ","
