...
plot_ly(
  ...
  colors = c('#8dd3c7', '#caffb3ff', '#bebada', '#fb8072'),
  type = 'scatter',
  mode = 'lines+markers',
  text = ~paste0(
    data_set_clean, 
...
datatable(
  ...
  options = list(
    ...
    order = list(list(ncol(img_summary_formatted) - 1, 'desc'))
  ),
  rownames = FALSE
)
```
...
```{r philips new test types, message=FALSE, warning=FALSE, results='hide', include=FASLE}
