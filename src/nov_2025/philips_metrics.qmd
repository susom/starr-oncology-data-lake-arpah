...
```{r, message=FALSE, warning=FALSE, results='hide'}
philips_den_sql<- "/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_denominator.sql"
ph_den <- fetch_data_from_sql_file(philips_den_sql, yaml_file_path)
ph_den$counts_pts

## aberration denominators 
abr_den_sql<- "/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_aberration_denominator.sql"
abr_den <- fetch_data_from_sql_file(abr_den_sql, yaml_file_path)
abr_den
```
```{r, message=FALSE, warning=FALSE, results='hide'}
test_sql="/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_tests_ordered.sql"
test_type=fetch_data_from_sql_file(test_sql, yaml_file_path)

test_date_sql="/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_tests_date_ordered.sql"
...
```{r, message=FALSE, warning=FALSE, results='hide'}
test_year_sql="/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_tests_date_ordered_year.sql"
...
As of November 2025, `r format(sum(test_type$test_type_counts), big.mark=",")` STAMP tests were ordered for `r format(ph_den$counts_pts[1], big.mark = ",")` patients. 
...
**Note**: Additional FoundationOne (F1) test data was backfilled between the May release and the Philips export dated from 07/13/25 to 08/05/25, which was used for the November release. More data is expected in future releases
...
```{r, message=FALSE, warning=FALSE, results='hide'}
pathg_sql<- "/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_abr_pathg.sql"
...
```{r,message=FALSE, warning=FALSE, results='hide' }
site_sql<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_site_display.sql"
...
```{r,message=FALSE, warning=FALSE , results='hide'}
gene_ch_sql<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_chrom_genes.sql"
...
```{r,message=FALSE, warning=FALSE , results='hide'}
gene_sql<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_gene.sql"
...
```{r, message=FALSE, warning=FALSE, results='hide'}
mu_type_sql<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_abr_type.sql"
...
sql_thr_abr<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_thr_abr.sql"
...
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_thr_genes<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_thr_abr_genes.sql"
...
sql_thr_kras<-"/workspaces/starr-oncology-data-lake-arpah/src/nov_2025/sql_std/philips/nov25/philips_thr_kras.sql"
...
#### Source Codes:
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/blob/main/src/nov_2025/philips_metrics.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/nov_2025/sql_std/philips)
