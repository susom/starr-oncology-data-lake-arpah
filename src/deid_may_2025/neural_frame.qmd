...
sql_den<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_den.sql"
nf_den <- fetch_data_from_sql_file(sql_den, yaml_file_path)
nf_den
```

```{r case status all ,message=FALSE, warning=FALSE, results='hide'}
sql_nf<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_case_status.sql"
...
sql_thr_case<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_case_status_person_metrics.sql"
...
sql_thr<-"/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_denominator.sql"
...
sql_thr_c<-"/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_denominator_complete.sql"
...
sql_thr_yr<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_completed_cases_dx_year_person_metrics.sql"
...
sql_thr_his <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_completed_cases_histology_person_metrics.sql"
...
sql_stg <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_stage_person_metrics.sql"
...
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_tx <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_completed_cases_tx_summary_person_metrics.sql"
...
recurrence <- read_csv("/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/data/recurrenceType_category.csv")
...
sql_rec <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_recurrence.sql"
...
sql_soh <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_social_history.sql"
...
```{r , message=FALSE, warning=FALSE, results='hide'}
sql_sm_omop <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/scr/thoracic/scr_thoracic_smoking_omop.sql"
