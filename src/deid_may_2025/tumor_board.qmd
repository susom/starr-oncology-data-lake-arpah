...
tb_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_person_metrics.sql"
...
## basic counts 
sql_thr<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/image_occ/image_occ_thoracic/image_occ_person_thr.sql"
res_den_thr<- fetch_data_from_sql_file(sql_thr, yaml_file_path)
head(res_den_thr)
```

As of May 2025, From `r format(res_den_thr$counts[1], big.mark = ",")` patients with thoracic cancer, `r format(tb_den$patient_count[1] , big.mark = ",")` also had a Tumor Board encounter. 

```{r demographic, message=FALSE, warning=FALSE, results='hide'}
# Parameters
sql_demg <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_demographic_all.sql"
...
# Parameters
sql_case <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_case_status.sql"
...
# Parameters
sql_img <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_imag_occ.sql"
...
### Anatomic Sites
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_image_an <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_imag_occ_anatomic.sql"
...
# Parameters
sql_img_mod <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_may_2025/sql/tumor_board/tumor_board_thoracic_imag_occ_modality.sql"
