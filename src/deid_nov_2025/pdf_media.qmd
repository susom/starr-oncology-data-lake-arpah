...
doc_counts_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/pdf_media/document_type_counts.sql"
doc_counts <- fetch_data_from_sql_file(doc_counts_sql, yaml_file_path)

# Load unique patient counts by document type
patient_counts_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/pdf_media/document_type_patient_counts.sql"
...
write.csv(categorized_data, 
          "/workspaces/starr-oncology-data-lake-arpah/src/deid_nov_2025/pdf_media_categorized_data.csv", 
          row.names = FALSE)
...
write.csv(category_summary_export, 
          "/workspaces/starr-oncology-data-lake-arpah/src/deid_nov_2025/pdf_media_category_summary.csv", 
          row.names = FALSE)
```
