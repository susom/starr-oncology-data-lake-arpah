...
tb_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_person_metrics.sql"
...
## basic counts 
sql_thr<- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/image_occ/image_occ_thoracic/image_occ_person_thr.sql"
...
# time trend
tb_time <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_over_time.sql"
...
# Parameters
sql_overlap <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_overlap.sql"
...
# Parameters
sql_demg <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_demographic_all.sql"
...
# Parameters
sql_case <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_case_status.sql"
...
# Parameters
sql_img <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_imag_occ.sql"
...
sql_image_an <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_imag_occ_anatomic.sql"
...
# Parameters
sql_img_mod <- "/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2025/sql/tumor_board_updated/tumor_board_thoracic_imag_occ_modality.sql"
...
### Source Codes:
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/deid_aug_2025/tumor_board_updated.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/deid_aug_2025/sql/tumor_board_updated). 
