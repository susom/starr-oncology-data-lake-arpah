...
tb_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_thoracic_person_metrics.sql"
...
## basic counts 
sql_thr<- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/image_occ_thoracic/image_occ_person_thr.sql"
...
# time trend
tb_time <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_over_time.sql"
...
tb_email_summary <- tb_data %>%
  group_by(tb_year) %>%
  summarise(
    total_patients  = n_distinct(person_id),
    .groups = "drop"
  ) %>%
  mutate(
    data  = "tb_emails", year = tb_year,
    n_tb_encounters = NA_real_,
    ratio = NA_real_
  )
...
p <- ggplot(dt_combined, aes(x = year, y = y_value, color = data, shape = data, group = data)) +
  ...
  labs(
    ...
    x = "Year",
    y = "Number of Encounters / Patients",
    color = NULL
  ) +
  theme(
...
# Parameters
sql_overlap <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_overlap.sql"
...
# Parameters
sql_demg <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_thoracic_demographic_all.sql"
...
# Parameters
sql_case <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_thoracic_case_status.sql"
...
# Parameters
sql_img <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/tumor_board/tumor_board_thoracic_imag_occ.sql"
...
sql_image_an <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/tumor_board/nov25/tumor_board_thoracic_imag_occ_anatomic.sql"
...
# Parameters
sql_img_mod <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/tumor_board/nov25/tumor_board_thoracic_imag_occ_modality.sql"
...
### Source Codes:
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/deid_aug_2026/tumor_board_updated.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/sql_std/tumor_board). 
