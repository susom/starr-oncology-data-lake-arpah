...
res_img_mod <- fetch_data_from_sql_file(sql_file_path_image_mod, yaml_file_path, release = "aug_2026")
head(res_img_mod)
...
pt_img <- fetch_data_from_sql_file(path_img, yaml_file_path, release = "aug_2026")
pt_img
...
res<- fetch_data_from_sql_file(sql_file_path_image, yaml_file_path, release = "aug_2026")
head(res)
...
res_thr<- fetch_data_from_sql_file(sql_thr_mod, yaml_file_path, release = "aug_2026")
head(res_thr)
res_thr
