...
**Analysis Data Sources:** This analysis reflects PHI scrubbed data from February 2025 to August 2026.
...
person_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  may_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql",
  aug_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/arpah_age_cat_metrics.sql"
)
...
person_res <- run_monthly_metrics(
  datasets_by_month = datasets_by_month,
  sql_file_path = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/person_metrics.sql"
)
...
var_res_aug=fetch_data_from_sql_file(var_den_sql, yaml_file_path, release = "aug_2026")
var_res_aug$counts_pts
var_res_aug$data_set<-"Philips ISPM"
var_res_aug$month<-"Aug 2026"
```
...
overlap_plot_data <- overlap_res %>%
  ...
  mutate(
    ...
    release_ordered = factor(release, 
                            levels = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026", "may_2026")),
...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      ticktext = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026"),
      tickvals = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026", "may_2026"),
      categoryorder = "array",
...
- February 2026 to August 2026 Philips ISPM/Genomic Data includes patients from OMOP _variant_occurrence table combined with Philips ISPM data.
...
if (nrow(ctsa_res) == 0) {
  ...
  bar_colors <- c('#8dd3c7', '#ffffb3', '#bebada', '#cbd6ab', '#80b1d3', '#fdb462')
...
death_sql_paths <- list(
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql",
  may_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql",
  aug_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/arpah_cohort/vital_status_person_metrics.sql"
)
...
plot_ly(data = thoracic_combined, x = ~month_label, y = ~patients, 
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      categoryorder = "array",
      categoryarray = c("May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026")
    ),
    yaxis = list(
      title = "Number of Patients",
      tickformat = ","
...
tb_overlap_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb25/tumor_board_overlap.sql",
...
**Imaging Coverage Growth**: The imaging dataset has expanded dramatically from approximately 93k patients in February 2025 to over 199k patients by May 2026, representing a substantial increase in multi-modal data availability for cancer research.
...
all_metrics <- all_metrics %>%
  filter(month_label != "Feb 2025") %>%
  mutate(
    metric = factor(metric, levels = metric_order),
    month_label = factor(month_label, levels = c("May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026"))
  )
...
img_summary <- img_mod %>%
  ...
  mutate(
    ...
    month_label = factor(month_label, levels = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026"))
  )
```
...
# Fetch Philips data for all historical releases using standardized SQL paths
...
philips_variant_all <- run_monthly_metrics(
  datasets_by_month = datasets_by_month[c("may_2025", "aug_2025", "nov_2025", "feb_2026", "may_2026")],
  sql_file_paths = philips_variant_sql_paths,
  release_to_month = release_to_month
)

# Fetch Feb 2026 accession numbers separately (combined/deduplicated)
feb26_acc_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/philips/philips_variant_denominator_test.sql"
feb26_acc <- fetch_data_from_sql_file(feb26_acc_sql, yaml_file_path, release = "feb_2026")

# Add accession numbers to the data
# For May-Nov: n_acc already in philips_variant_all
# For Feb 2026: add n_acc from the separate query result
#if (!"n_acc" %in% colnames(philips_variant_all)) {
  #philips_variant_all <- philips_variant_all %>%
  #  mutate(n_acc = NA_real_)
#}
...
philips_data_long <- philips_variant_all %>%
  mutate(
    month_label = factor(month, levels = c("May 2025", "Aug 2025", "Nov 2025", "Feb 2026", "May 2026")),
...
- February 2026 to August 2026 combine both Philips ISPM and OMOP _variant_occurrence sources (deduplicated)
