...
sql_den<- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_den.sql"
...
sql_nf<- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_case_status.sql"
...
sql_thr_case<- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_thoracic_case_status_person_metrics.sql"
...
sql_thr<-"/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_thoracic_denominator.sql"
...
sql_thr_c<-"/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_thoracic_denominator_complete.sql"
...
sql_thr_yr<- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_thoracic_completed_cases_dx_year_person_metrics.sql"
...
sql_thr_his <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/common/thoracic/nf_thoracic/scr_thoracic_completed_cases_histology_person_metrics.sql"
...
sql_stg <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_stage_person_metrics.sql"
...
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_tx <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_completed_cases_tx_summary_person_metrics copy.sql"
...
recurrence <- read_csv("/workspaces/starr-oncology-data-lake-arpah/src/deid_aug_2026/data/recurrenceType_category.csv")
...
sql_rec <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_recurrence.sql"
...
sql_soh <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_social_history.sql"
...
```{r , message=FALSE, warning=FALSE, results='hide'}
sql_sm_omop <- "/workspaces/starr-oncology-data-lake-arpah/src/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_smoking_omop.sql"
...
```{r protocol participation table, message=FALSE, warning=FALSE}
proto_table <- protocol_analysis %>%
  arrange(desc(enrolled_patients)) %>%
  head(15) %>%
  mutate(
    `Participation` = ifelse(is.na(eventprotocolparticipation), "Unknown", eventprotocolparticipation),
    `Trial Type` = ifelse(is.na(eventprotocoltrialtype), "Unknown", eventprotocoltrialtype),
    `Protocols` = format(unique_protocols, big.mark = ","),
    `Patients` = format(enrolled_patients, big.mark = ",")
  ) %>%
  select(`Participation`, `Trial Type`, `Protocols`, `Patients`)

create_gt_table_v1(
  data = proto_table,
  columns = c("Participation", "Trial Type", "Protocols", "Patients"),
  labels = c(
  ...
  subtitle_text = "Clinical Protocol Participation"
)
```
...
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/deid_aug_2026/neural_frame.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/sql_std/common/thoracic/nf_thoracic).
