...
tb_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_person_metrics.sql"
tb_den<- fetch_data_from_sql_file(tb_sql, yaml_file_path, release = "feb_2026")
tb_den
...
As of February 2026, From `r format(res_den_thr$counts[res_den_thr$variable_name=="Number of unique persons with thoracic cancer"], big.mark = ",")` patients with thoracic cancer, `r format(tb_den$patient_count[1] , big.mark = ",")` also had a Tumor Board encounter. 



```{r time trend, message=FALSE, warning=FALSE, results='hide'}
# time trend
tb_time <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_over_time.sql"
dt <- fetch_data_from_sql_file(tb_time, yaml_file_path, release = "feb_2026")
head(dt)
```
...
# Parameters
sql_overlap <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_overlap.sql"
res<- fetch_data_from_sql_file(sql_overlap, yaml_file_path, release = "feb_2026")
...
# Parameters
sql_demg <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_demographic_all.sql"
res <- fetch_data_from_sql_file(sql_demg, yaml_file_path, release = "feb_2026")
```
...
# Parameters
sql_case <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_case_status.sql"
case <- fetch_data_from_sql_file(sql_case, yaml_file_path, release = "feb_2026")
case
...
# Parameters
sql_img <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_imag_occ.sql"
tb_img<- fetch_data_from_sql_file(sql_img, yaml_file_path, release = "feb_2026")
tb_img
```
As of February 2026, `r format(tb_img$patient_count[1], big.mark = ",")` had image occurrence procedures.
...
sql_image_an <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_imag_occ_anatomic.sql"
res_ana <- fetch_data_from_sql_file(sql_image_an, yaml_file_path, release = "feb_2026")
head(res_ana)
...
# Parameters
sql_img_mod <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_imag_occ_modality.sql"
tb_img_mod<- fetch_data_from_sql_file(sql_img_mod, yaml_file_path, release = "feb_2026")
tb_img_mod
```
...
### Source Codes:
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/tumor_board_updated.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/sql/tumor_board_updated). 
