...
tb_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_person_metrics.sql"
...
tb_img
```
As of November 2025, `r format(tb_img$patient_count[1], big.mark = ",")` had image occurrence procedures.
