...
**Analysis Data Sources:** This analysis reflects the raw PHI data from February 2025 to February 2026.
...
person_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb25/person_metrics.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/person_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/person_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/nov25/person_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb26/person_metrics.sql"
...
person_res <- run_monthly_metrics(
  datasets_by_month = datasets_by_month,
  sql_file_path = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb26/person_metrics.sql"
)
...
demog <- run_monthly_metrics(
  datasets_by_month = datasets_by_month,
  sql_file_path = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/demographic_summary.sql"
)
```
...
overlap_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb25/arpah_denominators.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/arpah_denominators.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/arpah_denominators.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/nov25/arpah_denominators_update.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb26/arpah_denominators_update.sql"
)
...
var_den_sql="/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_variant_denominator.sql"
...
overlap_plot_data <- bind_rows(
  ...
  mutate(
    ...
    release_ordered = factor(release, 
                            levels = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026")),
...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      ticktext = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026"),
      tickvals = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026"),
      categoryorder = "array",
      categoryarray = c("feb_2025", "may_2025", "aug_2025", "nov_2025", "feb_2026")
    ),
    yaxis = list(
...
- The Tumor Board definition was updated in May 2025. February 2025 data uses the original definition based on encounter type, while May-November releases use an enhanced definition based on the OMOP visit_occurrence table, where the source value for the visit contains the phrase 'tumor board'.

- Feb 2026 Philips ISPM/Genomic Data includes patients from OMOP variant_occurrence table combined with Philips ISPM data.
...
ctsa_res <- run_monthly_metrics(
  datasets_by_month = datasets_by_month,
  sql_file_path = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/ctsa/metrics_uniq_pts_vital_overtime.sql",
  release_to_month = release_to_month)
...
if (nrow(ctsa_res) == 0) {
  ...
  ctsa_res <- ctsa_res %>% 
    mutate(month = factor(month, levels = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026"))) %>%
  ...
  ctsa_res <- ctsa_res %>%
    mutate(release_label = factor(
      ...
      levels = c("February 2025", "May 2025", "August 2025", "November 2025", "February 2026")
    ))
...
death_sql_paths <- list(
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/vital_status_person_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/may_aug25/vital_status_person_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/nov25/vital_status_person_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/arpah_cohort/feb26/vital_status_person_metrics.sql"
)
...
thoracic_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_denominator.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/may_aug25/nf_thoracic/scr_thoracic_denominator.sql", 
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/may_aug25/nf_thoracic/scr_thoracic_denominator.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/nov25/nf_thoracic/scr_thoracic_denominator.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_denominator.sql"
)
...
thoracic_complete_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_denominator_complete.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/may_aug25/nf_thoracic/scr_thoracic_denominator_complete.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/may_aug25/nf_thoracic/scr_thoracic_denominator_complete.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/nov25/nf_thoracic/scr_thoracic_denominator_complete.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_denominator_complete.sql"
)
...
thoracic_tb_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb25/nf_thoracic/scr_thoracic_tb_metrics.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/may25/tumor_board_thoracic_person_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/aug25/tumor_board_thoracic_person_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/nov25/tumor_board_thoracic_person_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_person_metrics.sql"
)
...
thoracic_tb_nf_sql_paths <- list(
  #feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb25/tumor_board_thoracic_neuralframe_metrics.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/may25/tumor_board_thoracic_neuralframe_metrics.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/aug25/tumor_board_thoracic_neuralframe_metrics.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/nov25/tumor_board_thoracic_neuralframe_metrics.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_thoracic_neuralframe_metrics.sql"
)
...
tb_overlap_sql_paths <- list(
  ...
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/may25/tumor_board_overlap.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/aug25/tumor_board_overlap.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/nov25/tumor_board_overlap.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/tumor_board/feb26/tumor_board_overlap.sql"
)
...
img_person_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb25/image_occ_person.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_person.sql", 
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_person.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/nov25/image_occ_person.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb26/image_occ_person.sql"
)
...
img_basic_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb25/image_occ_basic.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_basic.sql", 
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_basic.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/nov25/image_occ_basic.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb26/image_occ_basic.sql"
)
...
all_metrics <- all_metrics %>%
  mutate(
    ...
    month_label = factor(month_label, levels = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026"))
  )
...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      categoryorder = "array",
      categoryarray = c("Feb 2025", "May 2025", "Aug 2025", "Nov 2025", "Feb 2026")
    ),
    yaxis = list(
      title = "Count",
      tickformat = ","
...
img_mod_sql_paths <- list(
  feb_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb25/image_occ_modality.sql",
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_modality.sql", 
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/may_aug25/image_occ_modality.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/nov25/image_occ_modality.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/omop/image_occ/feb26/image_occ_modality.sql"
)
...
**Philips ISPM (May 2025 - October 2025)** - Discontinued
- Test types: STAMP, Heme-STAMP, Foundation One
- Variant types: Simple variants, CNVs, fusions
- Status: Data collection ended October 2025

**OMOP variant_occurrence (February 2026 - Present)** - Active
- Test types: STAMP only (Stanford Actionable Mutation Panel for Solid Tumors)
- Variant types: Simple variants only
- Status: Launched February 2026

**Transition Period (November 2025 - January 2026)**
- Data gap: No genomic variant data available during this period
- Future enhancements: Additional test types (Heme-STAMP, Foundation One) and variant types (CNVs, fusions) will be added in upcoming releases
...
philips_variant_sql_paths <- list(
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_denominator.sql",
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_denominator.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/nov25/philips_denominator.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_variant_denominator.sql"
)

philips_variant_all <- run_monthly_metrics(
  datasets_by_month = datasets_by_month[c("may_2025", "aug_2025", "nov_2025", "feb_2026")],
  sql_file_paths = philips_variant_sql_paths,
  release_to_month = release_to_month
)

# Fetch Feb 2026 accession numbers separately (combined/deduplicated)
feb26_acc_sql <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_variant_denominator_test.sql"
...
# For Feb 2026: use the separate accession query result
...
philips_tests_sql_paths <- list(
  may_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_tests_ordered.sql", 
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_tests_ordered.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/nov25/philips_tests_ordered.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_variant_denominator_test_type.sql"
)
...
philips_data_long <- philips_variant_all %>%
  mutate(
    month_label = factor(month, levels = c("May 2025", "Aug 2025", "Nov 2025", "Feb 2026")),
    is_combined = release == "feb_2026"
  ) %>%
  select(month_label, counts_pts, n_acc, total_tests, release, is_combined) %>%
  pivot_longer(
    cols = c(counts_pts, n_acc, total_tests),
    names_to = "metric",
    values_to = "count"
  ) %>%
  mutate(
    metric_label = case_when(
      ...
      metric == "total_tests" ~ "Total Tests"
    )
  )
...
plot_ly() %>%
  ...
  add_trace(
    data = filter(philips_data_long, metric == "total_tests"),
    x = ~month_label,
    y = ~count,
    type = 'scatter',
    mode = 'lines+markers',
    name = "Total Tests (All Types)",
    line = list(color = '#bebada', width = 3),
    marker = list(
      size = ~ifelse(is_combined, 15, 12),
      color = '#bebada',
      symbol = ~ifelse(is_combined, 'diamond', 'circle')
    ...
    text = ~paste0(
      ifelse(is_combined, "<b>Combined Sources</b>", "<b>Philips ISPM</b>"),
      "<br>", month_label,
      "<br>Total Tests: ", scales::comma(count),
      ifelse(is_combined, 
             "<br><i>All test types from both sources</i>",
             "<br><i>STAMP, Heme-STAMP, Foundation One</i>")
    ),
    hoverinfo = "text",
    visible = TRUE
  ) 
...
feb26_test_types_plot <- feb26_test_types %>% 
...
p %>%
  layout(
    ...
    xaxis = list(
      title = "",
      categoryorder = "array",
      categoryarray = c("May 2025", "Aug 2025", "Nov 2025", "Feb 2026"),
    ...
    annotations = list(
      ...
      list(
        text = "<b>Philips ISPM<br>Discontinued</b><br>(Oct 2025)",
        x = "Nov 2025",
        y = 1.08,
        yref = "paper",
        showarrow = FALSE,
      ...
      # Annotation for data gap period
      list(
        text = "<b>Data Gap</b><br>(Nov 2025 - Jan 2026)<br>Transition period",
        x = "Nov 2025",
        y = 0.5,
        yref = "paper",
        xref = "x",
        ...
        arrowsize = 1,
        arrowwidth = 2,
        arrowcolor = "rgba(200,100,100,0.6)",
        ax = 40,
        ay = -20,
...
- There is a data gap from November 2025 through January 2026 during the transition period
- February 2026 combines both Philips ISPM and OMOP variant_occurrence sources (deduplicated)
- OMOP variant_occurrence currently includes STAMP simple variants only
- Complete variant coverage (including fusions, CNVs, and Foundation One) will be restored in future releases
...
philips_denom_sql_paths <- list(
  ...
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_denominator.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/nov25/philips_denominator.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_denominator.sql"
)
...
philips_tests_sql_paths <- list(
  ...
  aug_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/may_aug25/philips_tests_ordered.sql",
  nov_2025 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/nov25/philips_tests_ordered.sql",
  feb_2026 = "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_tests_ordered.sql"
)
...
philips_overview <- philips_denom %>%
  mutate(
    release = factor(release, levels = c("may_2025", "aug_2025", "nov_2025", "feb_2026")),
    month_label = recode(release,
      "may_2025" = "May 2025",
      "aug_2025" = "August 2025",
      "nov_2025" = "November 2025",
...
plot_ly(
  ...
  layout(
    ...
    xaxis = list(
      title = "",
      categoryorder = "array",
      categoryarray = c("May 2025", "August 2025", "November 2025", "February 2026")
    ),
    yaxis = list(
      title = "Count",
      tickformat = ","
...
plot_ly(
  ...
  y = ~test_type_counts,
  color = ~test_type,
  colors = c('#FFB3BA', '#FFDFBA', '#FFFFBA', '#BAFFC9', '#BAE1FF', '#E0BBE4', '#FFC9DE', '#C9E4DE'),
  type = 'bar',
  text = ~paste0(
    test_type,
    "<br>", month,
...
sql_philips<- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/philips/feb26/philips_stanford_tests_ordered.sql"
