...
sql_den<- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_den.sql"
nf_den <- fetch_data_from_sql_file(sql_den, yaml_file_path, release = "feb_2026")
nf_den
```

```{r case status all ,message=FALSE, warning=FALSE, results='hide'}
sql_nf<- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_case_status.sql"
case <- fetch_data_from_sql_file(sql_nf, yaml_file_path, release = "feb_2026")
head(case)
...
sql_thr_case<- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_case_status_person_metrics.sql"
thr_case <- fetch_data_from_sql_file(sql_thr_case, yaml_file_path, release = "feb_2026")
head(thr_case)
thr_case$flag="Thoracic Cancer"
thr_case$nfcasestatus[thr_case$nfcasestatus=="Incomplete - Edit"]<-"Incomplete"


sql_thr<-"/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_denominator.sql"

thr_den=fetch_data_from_sql_file(sql_thr, yaml_file_path, release = "feb_2026")
thr_den
```
```{r,message=FALSE, warning=FALSE, results='hide'}
# Calculate counts and percentages using unique person counts
...
sql_thr_c<-"/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_denominator_complete.sql"

thr_den_c=fetch_data_from_sql_file(sql_thr_c, yaml_file_path, release = "feb_2026")
thr_den_c
## denominators ##
sum_thr_c=thr_den_c$unique_thoracic_cancer_pts
sum_thr=thr_den$unique_thoracic_cancer_pts
```
As of November 2025, there are  `r format(thr_den$unique_thoracic_cancer_pts, big.mark = ",")` unique thoracic patients with `r format(case_thr$Percentage[case_thr$Status=="Completed"], big.mark = ",")` % completed cases. 
...
sql_thr_yr<- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_completed_cases_dx_year_person_metrics.sql"
thr_yr <- fetch_data_from_sql_file(sql_thr_yr, yaml_file_path, release = "feb_2026")
...
sql_thr_his <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_completed_cases_histology_person_metrics.sql"
thr_his <- fetch_data_from_sql_file(sql_thr_his, yaml_file_path, release = "feb_2026")
...
sql_stg <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_stage_person_metrics.sql"
thr_stg <- fetch_data_from_sql_file(sql_stg, yaml_file_path, release = "feb_2026")
thr_stg
...
```{r, message=FALSE, warning=FALSE, results='hide'}
sql_tx <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_completed_cases_tx_summary_person_metrics.sql"
thr_tx <- fetch_data_from_sql_file(sql_tx, yaml_file_path, release = "feb_2026")
...
recurrence <- read_csv("/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/data/recurrenceType_category.csv")
...
sql_rec <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_recurrence.sql"
thr_rec <- fetch_data_from_sql_file(sql_rec, yaml_file_path, release = "feb_2026")
...
sql_soh <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_social_history.sql"
thr_soh <- fetch_data_from_sql_file(sql_soh, yaml_file_path, release = "feb_2026")
...
```{r , message=FALSE, warning=FALSE, results='hide'}
sql_sm_omop <- "/workspaces/starr-oncology-data-lake-arpah/src/feb_2026/sql_std/thoracic/feb26/nf_thoracic/scr_thoracic_smoking_omop.sql"
thr_smk <- fetch_data_from_sql_file(sql_sm_omop, yaml_file_path, release = "feb_2026")
...
The source codes for this page can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/neural_frame.qmd), and the sql queries that support the metrics can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/sql_std/neural_frame). 
The queries regarding thoracic cancer can be found [here](https://github.com/susom/starr-oncology-data-lake-arpah/tree/main/src/feb_2026/sql_std/nf_thoracic).
